...
{
    class VideoPlayerViewModel : INotifyPropertyChanged
    {
        private readonly VideoView VideoView;

        public VideoPlayerViewModel(VideoView videoView)
        {
            VideoView = videoView;
        }
        ...
        private string _Source = "http://www.sample-videos.com/video/mp4/720/video123/mp4/720/big_buck_bunny_720p_1mb.mp4";
